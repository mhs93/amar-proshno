...
?>
    ...
    if (isset($_GET["editid"])){
        $editId = $_GET["editid"];
        $sql = "SELECT * FROM question WHERE id='$editId' ";
            ...
            <div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2 class="panel-title text-center">Update Your Question</h2>
                    </div>
                    <?php
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if (!empty($title) && !empty($body)){
                            ...
                            $sql = "UPDATE question SET title=:title, body=:body WHERE id=:id";
                            $stmt = Database::Prepare($sql);
                            ...
                            if ($satatus){
                    ?>
                                <h3 class="text-center"><span style='color: darkgreen'>Question updated successfully</span></h3>
                    <?php
                            }else{
                    ?>
                                <h3 class="text-center"><span style='color: #ac2925'>Question update failed!</span></h3>
                    <?php
                            }
                        }else{
                    ?>
                        ...
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <input class="form-control" type="text" name="title" value="<?php echo
                                    $val['title']; ?>" required>
                                </div>
                            </div>
