                    ...
                    <div class="panel-body">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
                            if (empty($_POST["password"])){
                                echo "<span style='color: #ac2925'>Password field must not be empty!</span><br>";
                            }elseif (empty($_POST["confirm"])){
                                echo "<span style='color: #ac2925'>Please Confirm password!</span><br>";
                            }elseif ($_POST["password"] !== $_POST["confirm"]){
                                echo "<span style='color: #ac2925'>Your submitted password don't match! Please submit same password!</span>";
                            }else{
                                $users->updatePassword($_POST["password"]);
                            }
                        }
                        ?>
                    </h3>
                    <hr>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="text-center">
                                <button class="btn btn-action" name="submit" type="submit">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
