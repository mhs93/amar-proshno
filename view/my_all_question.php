            ...
            <div class="col-md-12">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <?php }else{?>
                            <li <?php if ($CurreentPage == 'my_all_question'){echo 'class="active"';} ?>

                            ><a href="my_all_question.php">My All Question</a></li>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                            <span style="font-size: 16px;">
                                ...
                                <p><?php echo $question->textShorten($value['body']); ?></p>
                                <nav aria-label="...">

                                    <ul class="pager">
                                        <li class="next"><a style="margin-left: 3px;" href="details.php?detailId=<?php echo $value['id']; ?>">Answer <span class="glyphicon  glyphicon-hand-right"  aria-hidden="true"></span></a></li>
                                        <li class="next"><a onclick="return confirm('are you sure to delete?');"
                                                            style="margin-left:3px;" href="delete.php?deleteid=<?php echo $value['id'];?>
                                                            ">Delete</a></li>
                                        <li class="next"><a style="margin-left: 3px;" href="edit.php?editid=<?php echo $value['id'];?>">Edit</a></li>
                                    </ul>
                                </nav>
                            </span>
                        </div>
