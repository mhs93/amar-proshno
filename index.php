...
<head>
	...
	<link rel="stylesheet" href="view/assets/css/bootstrap-theme.css" media="screen" >
						...
						<ul class="nav navbar-nav pull-right">
							...
							<li role="presentation" class="dropdown">
								...
								<ul class="dropdown-menu" style="background-color: black">
									...
									<li><a class="active" href="view/category.php?categoryId=<?php echo $value['id']; ?>"><?php echo $value['name']; ?></a></li>
									<?php  }  ?>
								</ul>
							</li>
							...
							<li><a class="btn btn-default" href="view/signin.php">Login / Sign Up</a></li>
                            <?php }else{?>
                                <li><a href="view/my_all_question.php">My All Question</a></li>
		...
		<div class="container">
			<div class="row height">
                ...
                <div class="form-group col-md-8">
                    ...
                    <form action="view/search.php" method="post" role="search">
                    <input type="search" name="search" class="form-control" placeholder="Search"><br>
                    <button class="btn btn-default" type="submit">Search</button>
                    </form>
                </div>
                <div class="col-md-4">
                    <a href="view/my_question.php"><button class="btn
		...
		<div class="row">
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation"><a href="view/my_all_question.php">My Questions</a></li>
                    <li role="presentation"><a href="view/my_all_Answers.php">My Answers</a></li>
                    <?php  } ?>
                </ul>
<?php
$per_page = 4;
...
<?php
$query = "SELECT * FROM question ORDER BY id DESC LIMIT $star_from, $per_page  ";
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
            ...
            ?>
            <label class="label">
                <a style="color: #000000;" href="view/view_profile.php?userProfile=<?php echo $userDetails['id'];?>">
                <img style="border: solid 1px #91A67F; padding: 3px; border-radius: 5px;"
                     src="view/<?php echo $userDetails['image'];?>">
            ...
            <span style="font-size: 16px;">
                ...
                <nav aria-label="...">
                    ...
                    <ul class="pager">
                        ...
                        <li class="next"><a style="margin-left: 3px;" href="view/details.php?detailId=<?php echo urlencode($value['id']); ?>">Answer <span class="glyphicon  glyphicon-hand-right"  aria-hidden="true"></span></a></li>
                        ...
                        <li class="next"><a onclick="return confirm('are you sure to delete?');"
                                            style="margin-left:3px;" href="view/delete.php?deleteid=<?php
                            echo urlencode($value['id']);?>&page=<?php echo urlencode($page); ?>">Delete</a></li>
                        <li class="next"><a style="margin-left: 3px;" href="view/edit.php?editid=<?php echo urlencode($value['id']);?>&page=<?php echo urlencode($page); ?>">Edit</a></li>
                        <?php } ?>
                    </ul>
                </nav>
            </span>
        ...
        <div class="text-center col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            ?>
                <span class="glyphicon  glyphicon-th-list"></span> In <a href="view/category.php?categoryId=<?php echo $catName['id'];?>"><?php echo $catName['name'];?></a>
            <?php } ?>
...
<?php if (!Session::get("userid")){ ?>
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="font-weight: normal">
            ...
            <a class="btn btn-action" href="view/signup.php">Join</a>
        </div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h2 class="panel-title text-center"><a href="view/my_all_question.php">My Asking Questions</a></h2>
    </div>
    <div class="panel-body">
        <ol>
            <?php
        ...
        <ul class="pager">
            <li class="next">
                ...
                if ($num > 2){
                ?>
                <a href="view/my_all_question.php">More...<span class="glyphicon  glyphicon-hand-right"
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h2 class="panel-title text-center"><a href="view/my_all_Answers.php">My Answers..</a></h2>
    </div>
    <div class="panel-body" style="font-weight: normal">
        <ol>
            <?php
        ...
        <ul class="pager">
            <li class="next">
                ...
                if ($num > 2){
                    ?>
                    <a href="view/my_all_Answers.php">More...<span class="glyphicon  glyphicon-hand-right"
                                                                    aria-hidden="true"></span></a>
                <?php }elseif ($num == 0){
...
<?php  } ?>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="text-right">
								Copyright &copy; <?php date('Y'); ?> <a href="#" rel="designer">Mominul Hasan</a>
							</p>
						</div>
					</div>
	...
	<script src="view/assets/js/headroom.min.js"></script>
	<script src="view/assets/js/jQuery.headroom.min.js"></script>
